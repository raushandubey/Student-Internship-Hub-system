...
<div class="px-4 py-5 max-w-lg mx-auto" style="padding-bottom: 100px;">
    ...
    {{-- Info Banner --}}
    <div class="bg-blue-50 border border-blue-200 rounded-xl p-3.5 mb-4 flex gap-2.5">
    ...
    <div class="rounded-2xl p-4 mb-5" style="background:linear-gradient(135deg,#7c3aed 0%,#4f46e5 100%);">
        <div class="flex items-center justify-between gap-3">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-purple-100 text-xs">Check resume match score before applying</p>
                </div>
            </div>
            <button type="button"
                    onclick="ResumeOptimizer.open({{ $internship->id }})"
                    class="flex-shrink-0 bg-white text-purple-700 font-bold text-xs px-4 py-2 rounded-xl active:scale-95">
